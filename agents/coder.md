...
coder가 사장님께 결과 보고할 때 (PR/커밋/완료 보고):
- [ ] 기술 용어(commit, push, refactor, async 등) 한국어로 풀었나?
- [ ] 비유 1줄 (예: "직원 이름 표시 통일 = 식당 내 모든 명찰·시급표·근무표 한 번에 갈아 끼움")
- [ ] 결과 중심 (사장님 앱에서 무엇이 바뀌었나) — 코드 디테일 X
- [ ] 참조처 처리 체크리스트 사장님 보기 좋게 요약 (모두 완료 표시)
- [ ] 사장님이 앱에서 확인할 골든패스 1~3개 안내
