...
- 품목명(i): 한국 영수증(원화·한글 위주)이면 한자 병기(龍蝦毬·魚子福袋 등)는 보조표기라 무시하고 한글만 적기. 한자가 본문인 영수증(중국 등)이면 한자 그대로. 흐릿한 오탈자는 맞는 단어로 교정(옥수무→옥수수). ⚠️모르는 약어·흐릿한 글자를 그럴듯하게 지어내지 마라(환각 금지) — 못 읽으면 보이는 글자 그대로. 품목코드 숫자는 품목명에 넣지 마라.
