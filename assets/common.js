...
- [한자 제거] i(품목명)에 한자(漢字)가 섞여 있으면 그 한자 글자는 모두 빼고 한글만 남겨라. 예) "위즈복대-魚子福袋"→"위즈복대" / "흑목이버섯 1kg-黑木耳"→"흑목이버섯 1kg" / "호스 쌀국수-春絲 米線"→"호스 쌀국수" / "행사/가재완자/홍샤쥬/龍蝦球"→"행사/가재완자/홍샤쥬". 읽기 어려운 글자를 비슷한 한국어 음식 이름으로 추측·창작하지 마라. 안 보이면 보이는 한글만 남겨라.
- p·u·q는 양수만 — 할인 행 제외
