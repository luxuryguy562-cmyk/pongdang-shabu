...
③ 소계·배송비·구분행 제외: "소계"·"합계"·"배송비"·"배송지"·"쿠팡 직접판매" 등 집계/구분 행 = items 제외.
④ total_sum = 페이지 하단 "결제금액"/"총 결제금액" 최종값만. 배송그룹별 소계 X.${multiPageHint}
...
[예시 — 온라인 주문 (쿠팡, 분리배송 + 할인)]
{"date":"2026-06-08","items":[{"i":"진로토닉워터 300ml 24입","u":56820,"q":1,"p":56820,"c":"식자재"},{"i":"코카콜라제로 355ml 24입","u":18000,"q":1,"p":18000,"c":"식자재"}],"total_sum":169540}
(분리배송으로 진로토닉워터가 3개 배송그룹에 반복 표시돼도 items엔 1번만. 화면 하단 "총 결제금액"=total_sum. 별도 "할인 -14,760" 행은 items 제외 — 상품가에 이미 반영됨)`;
}
