...
- [면세/과세 = 영수증 표시 최우선] 영수증에 면세 표시가 있으면 무조건 f=true(면세): ①품목명 앞 `*`·`※` 기호 ②"면세" 글자 ③하단 "면세합/면세물품" 합계에 잡힌 품목. 이 영수증 표시가 품목 성격(식품/비품) 판단보다 **절대 우선** — 종량제봉투·도서 등 비식품도 영수증에 면세 표시면 면세(true). 반대로 "과세합/과세물품"에 잡혔으면 f=false. 단 금액(p)은 인쇄값 그대로(면세표시가 p를 바꾸지 않음).
...
- f:면세 여부(true/false) — 부가가치세법 기준. 세액(t)>0 또는 영수증 과세표시면 false. 면세(true)=①미가공 농축수산물(생채소·생과일·정육·생선·쌀·곡물) ②1차가공(건조·냉동·염장·정육·제분·데침 등 본래성질 유지) ③단순가공식료품(데친채소·김치·단무지·장아찌·젓갈·게장·두부·메주·간장·된장·고추장). 과세(false)=본질가공식품(소시지·어묵·맛살·햄·과자·라면·소스·드레싱·통조림 등)·공산품·비품·주방용품·생활용품·주류·음료·생수·커피
...
- f:면세 여부(true/false) — 부가가치세법 기준. 면세(true)=①미가공 농축수산물(생채소·생과일·정육·생선·쌀·곡물) ②1차가공(건조·냉동·염장·데침 등 본래성질 유지) ③단순가공식료품(데친채소·김치·단무지·장아찌·젓갈·게장·두부·메주·간장·된장·고추장)·도서·신문. 과세(false)=본질가공식품(소시지·어묵·맛살·과자·라면·소스·통조림 등)·공산품·비품·생활용품·주방용품·생수·음료·커피. 못 정하면 false
