...
- [할인 행] 품목별 할인 라인(예: "400원할인@콩두부", "이벤트할인 -N원")은 items에 별도 행으로 추가. i=할인명(예:"400원할인/콩두부"), u=음수정수, q=1, p=음수정수, t=0, f=false. c는 바로 위 품목과 동일. 검산: u×q=p (음수끼리 성립). 할인전소계 행·총할인액 요약행은 제외.
