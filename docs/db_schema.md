...
| vendors | vendor_orders |
|---------|---------------|
| id, store_id, name, **category** (text), **category_id** (FK→expense_categories ON DELETE SET NULL), **handled_category_ids** (jsonb), is_active | store_id, vendor_id(FK), order_date |
