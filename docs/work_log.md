...
- ⏳ 다음(미구현): ② 직원관리에 직급권한 설정 UI(직급 선택 seg + 탭5 스위치 + 저장) ③ applyPermissionUI를 currentEmp.role 기반 nav 가시성으로 확장. 목업=docs/mockups/2026-06-15_role_perm_setting.html (사장님 확인 대기).
