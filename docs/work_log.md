...
## [2026-05-20] 관리자 대시보드 1차+2차 핵심 (#admin) — AI 비용 + 학습 규칙 관리

### 상태: 구현 완료, 사장님 미리보기 검증 대기
### 브랜치: `claude/admin-dashboard-HDLZM`
### 미리보기: `claude-admin-dashboard-hdlzm.pongdang-shabu.pages.dev` (1~2분 후 자동 생성)
